...
const Navbar = () => {
    ...
    const handleVoiceSearch = () => {
        ...
        if (!SpeechRecognition) {
            ...
            setIsListening(false);
            setVoiceTranscript("Voice search not supported. Please use Chrome or Safari.");
    ...
    const navLinks = [
        ...
        { name: "Web Series", href: "/webseries" },
                        ...
                        >
                            <div className="flex items-center gap-2 md:gap-3.5 lg:gap-6 xl:gap-8 min-w-0">
                                <Link href="/" className="group flex-shrink-0 flex items-center gap-2">
                                    ...
                                    >
                                        <BrandLogo
                                            iconClass="h-7 w-7 sm:h-8 sm:w-8"
                                            textClass="text-[14px] sm:text-[17px]"
                                        />
                                    </motion.div>
                                </Link>
