...
const DetailsHero = ({ tmdbData, type, onPlay, currentSeason, onSeasonChange, currentEpisode }: DetailsHeroProps) => {
    ...
    return (
        <div data-details-hero="true" className="relative w-full min-h-[50vh] lg:min-h-[65vh] flex items-start bg-black pt-16 md:pt-12 pb-6 md:pb-10">
            {/* Background Blur */}
            ...
            <div className="relative z-40 w-full px-6 md:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <motion.p
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.4 }}
                        className="text-sm sm:text-base md:text-xl text-gray-300 font-medium drop-shadow-md line-clamp-2 sm:line-clamp-3 md:line-clamp-4 leading-relaxed max-w-2xl"
                    >
                        {tmdbData.overview}
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.4 }}
                        className="flex flex-col gap-4 md:gap-8 pt-2 md:pt-4"
                    >
