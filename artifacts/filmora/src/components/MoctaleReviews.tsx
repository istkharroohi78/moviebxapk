    ...
    return (
        ...
        >
            ...
            <div className="text-center text-[14px] text-gray-500/80 max-w-2xl mx-auto pt-8 border-t border-white/5 leading-relaxed font-light">
                Disclaimer: {siteConfig.name} is not affiliated with and does not own Moctale. Review content is sourced from public endpoints and will be promptly removed upon request.
            </div>
        </motion.div>
    );
}
