        ...
        <div className="space-y-12 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12">
          <section>
            ...
            <p className="leading-relaxed">
              At {siteConfig.name}, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-6 bg-white/5 border border-white/10 rounded-2xl">
              <p className="text-white font-semibold">{siteConfig.name} Support</p>
              <p className="text-accent">{siteConfig.contactEmail}</p>
            </div>
          </section>
        </div>
      </div>
