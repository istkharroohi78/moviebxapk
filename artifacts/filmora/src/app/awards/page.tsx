                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start text-gray-400">
                    <div className="space-y-6">
                        ...
                        <p className="leading-relaxed">
                            ...
                            At {siteConfig.name}, we've curated lists of the most prestigious award-winning films from around the globe, ensuring you have access to the very best that the world of movies has to offer.
                        </p>
                        <p className="leading-relaxed">
