        ...
        <div className="space-y-12 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing or using {siteConfig.name}, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              {siteConfig.name} is a streaming search engine that provides links to content hosted on third-party servers. We do not host any copyrighted material on our own servers.
            </p>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {siteConfig.name} does not host any media files. We strictly act as a search engine. We respond to clear notices of alleged copyright infringement. For more information, please visit our <a href="/dmca" className="text-accent hover:underline">DMCA page</a>.
            </p>
          </section>
