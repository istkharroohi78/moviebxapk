...
export const metadata: Metadata = {
    title: `Production Studios & Companies | ${siteConfig.name}`,
    description: `Discover the world's leading film production companies, iconic studios, and entertainment networks that shape modern cinema on ${siteConfig.name}.`,
};
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start text-gray-400">
                    <div className="space-y-6">
                        ...
                        <p className="leading-relaxed">
                            ...
                            At {siteConfig.name}, we spotlight these iconic institutions, allowing you to explore the vast filmographies of the world's most influential studios.
                        </p>
                        <p className="leading-relaxed">
