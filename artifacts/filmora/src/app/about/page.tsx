...
export const metadata = {
  ...
  description: `Learn more about ${siteConfig.name}, the premier destination for free movie and TV show streaming discovery.`,
  alternates: {
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <article className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-accent/30 transition-all duration-300">
            ...
            <p className="text-sm leading-relaxed">
              {siteConfig.name} was created by movie lovers, for movie lovers. Every feature is designed with the user in mind—from our ultra-clean interface to our lightning-fast search capabilities.
            </p>
          </article>
        </section>
        ...
        <section className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Our team works tirelessly to ensure {siteConfig.name} remains fast and reliable, even during peak traffic hours.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 space-y-6 border-t border-white/10 pt-8 text-sm leading-relaxed">
            <p>
              {siteConfig.name} was born out of a desire to create a streaming discovery platform that feels as premium as the content it showcases.
            ...
            <p>
              Technologically, {siteConfig.name} leverages the latest in web standards, including Next.js for high-performance server-side rendering and Tailwind CSS for a sleek, responsive interface.
        ...
        <section className="text-center bg-gradient-to-r from-accent/10 to-teal-500/10 border border-white/10 rounded-3xl p-10">
          ...
          <a href={`mailto:${siteConfig.contactEmail}`} className="inline-block bg-accent text-black font-black px-8 py-3 rounded-2xl hover:brightness-110 transition-all">
            Contact Support
          </a>
        </section>
      </div>
