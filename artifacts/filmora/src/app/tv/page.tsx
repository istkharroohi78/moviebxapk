...
export const metadata: Metadata = {
    title: `Watch Top Rated TV Series and Shows Online Free | ${siteConfig.name}`,
    description: `Watch the top rated TV series and shows online for free. Stream the best TV shows, currently airing series, and all-time favorites on ${siteConfig.name}.`,
    alternates: {
                    ...
                    __html: JSON.stringify({
                        ...
                        "itemListElement": trending.slice(0, 10).map((show, index) => ({
                            ...
                            "item": {
                                ...
                                "url": `${siteConfig.url}/watch/tv/${show.id}`,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 leading-relaxed text-lg">
                            Experience the best of television with {siteConfig.name}&apos;s comprehensive library of TV shows and series.
                        ...
                        <p className="text-gray-400 leading-relaxed text-lg">
                            ...
                            With {siteConfig.name}, you can track your progress, discover new shows based on your interests, and enjoy a premium streaming experience tailored for TV enthusiasts.
                        </p>
                    </div>
