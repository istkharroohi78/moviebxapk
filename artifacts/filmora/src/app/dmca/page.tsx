...
export const metadata: Metadata = {
    title: "DMCA Policy",
    description: `${siteConfig.name} respects the intellectual property rights of others and expects its users to do the same.`,
    alternates: {
            ...
            <div className="max-w-3xl mx-auto px-6 pt-40 md:pt-32 pb-24 space-y-8">
                <header className="space-y-4 border-b border-gray-800 pb-8">
                    ...
                    <p className="text-lg text-gray-400">
                        Is {siteConfig.name} Legal?
                    </p>
                </header>

                <section className="space-y-4">
                    <p>
                        {siteConfig.name} operates in a legal gray area. Copyright laws vary significantly from country to country, and the legality of streaming services can be complex and subject to interpretation.
                    </p>
                    <p>
                        {siteConfig.name} does not host any content on our servers. We simply provide links to media hosted on third-party services that are publicly available on the internet.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        Users should be aware of the copyright laws in their respective countries and use {siteConfig.name} at their own discretion and risk.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-prime-card p-4 rounded-lg border border-gray-800">
                        <span className="text-prime-blue font-bold">Email:</span> {siteConfig.contactEmail}
                    </div>
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        {siteConfig.name} is not responsible for and has no control over the content of any third-party website. We do not host any content and have no control over the nature, content, or availability of those sites.
                    </p>
                    <p>
