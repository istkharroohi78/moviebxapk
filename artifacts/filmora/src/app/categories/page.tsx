...
export const metadata: Metadata = {
    ...
    description: `Browse through a wide range of movie and TV show categories on ${siteConfig.name}.`,
    alternates: {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start text-gray-400">
                    <div className="space-y-6">
                        ...
                        <p className="leading-relaxed">
                            ...
                            At {siteConfig.name}, we've organized our vast library into intuitive categories, making it easier than ever to find the exact type of story you're in the mood for. 
