...
export const metadata: Metadata = {
    title: `Cast & Creators | ${siteConfig.name}`,
    description: `Browse the world's most popular screen icons, actors, legendary directors, and brilliant screenwriters on ${siteConfig.name}.`,
};
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start text-gray-400">
                    <div className="space-y-6">
                        ...
                        <p className="leading-relaxed">
                            ...
                            At {siteConfig.name}, we celebrate these talented individuals, providing you with deep insights into their careers and contributions to the world of entertainment.
                        </p>
                        <p className="leading-relaxed">
