...
SESSION = environ.get('SESSION', 'hhghyygb')
API_ID = int(environ.get('API_ID', '23491399'))
API_HASH = environ.get('API_HASH', '2b7f62a2c17cdb83427074b9615cdb90')
BOT_TOKEN = environ.get('TELEGRAM_BOT_TOKEN') or environ.get('BOT_TOKEN', '')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003704179556'))  # Log channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('MONGODB_URI') or environ.get('DATABASE_URI', "mongodb+srv://ftm:ftm@cluster0.tseoajm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://ftm:ftm@cluster0.tseoajm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
_REPLIT_DOMAINS = environ.get('REPLIT_DOMAINS', '')
_AUTO_WEBSITE_URL = f"https://{_REPLIT_DOMAINS.split(',')[0]}" if _REPLIT_DOMAINS else ''
WEBSITE_URL = environ.get('WEBSITE_URL', _AUTO_WEBSITE_URL).rstrip('/')  # Website URL for watch/info links
...
PORT = environ.get("BOT_PORT", environ.get("PORT", "8082"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '3dc01a3b-3ebe-410e-b11f-dac4a86da32c-00-1dypsm42uls7h.pike.replit.dev'))
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'uuhuh'))
MULTI_CLIENT = False
